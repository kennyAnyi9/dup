...
import { buttonVariants } from "@/shared/components/dupui/button";
...
export function Header() {
  ...
  return (
    <div className="sticky top-0 z-50 bg-background">
      <div className="mx-auto flex max-w-screen-lg items-center justify-between px-4 sm:px-8">
        <Link className="flex items-center space-x-1 py-5" href="/">
          <SquareDashedBottom className="size-4" />
          <h1 className="font-semibold text-lg">dup</h1>
        </Link>
        ...
        <div className="flex items-center space-x-2">
          ...
          >
            ...
            <span className="hidden sm:inline">kennyAnyi9/dup</span>
          </a>
        </div>
      </div>
    </div>
