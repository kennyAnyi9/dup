...
export default function Home() {
  return (
      ...
      <Panel className="grid-section relative overflow-hidden border-none [.grid-section_~_&]:border-t-0">
          ...
          <Link
          className="w-fit mb-5 relative inline-flex items-center justify-center gap-2 whitespace-nowrap text-xs sm:text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg:not([className*='size-'])]:size-4 shrink-0 [&amp;_svg]:shrink-0 border-[0.1px]S shadow-xs h-8 has-[&gt;svg]:px-3 rounded-xl"
