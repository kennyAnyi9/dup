                ...
                <div className="flex items-center border-l h-full">
                  {isAuthenticated ? (
                    <div className="h-full flex place-items-center ">
                      <Link
                        href="/dashboard"
                        className="h-full flex place-items-center w-44 p-5 hover:bg-accent"
                      >
                        Dashboard
                      </Link>
                    </div>
                    ...
                    <div className="flex items-center h-full">
                      <Link
                        className="h-full border-r flex place-items-center hover:bg-accent w-44 p-5"
                        href="/login"
                      >
                        Login
                      </Link>
                      <Link
                        className="h-full flex place-items-center hover:bg-accent w-44 p-5"
                        href="/register"
                      >
                        Register
                      </Link>
